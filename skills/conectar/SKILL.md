...
Se `capacidades.md` já existe: leia, mostre a tabela atual e pergunte o que mudou. Atualize linha por linha e **nunca reescreva do zero**, porque o arquivo é dela e pode ter sido editado à mão. Provider que saiu volta pra célula vazia; nunca deixe linha apontando pra ferramenta que não responde mais. O passo 4 roda de novo junto.
