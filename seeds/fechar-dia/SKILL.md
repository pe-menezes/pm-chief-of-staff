...
7. **Responder curto:** compilado + balanço (`N/3` + motivo) + semente de amanhã. Sem cheerleading. No último dia útil da semana, fechar com 1 linha de oferta: existindo `.claude/skills/fechar-semana/` na pasta, "é sexta: fecho a semana também?"; sem a pasta, "é sexta: quer fechar a semana também? eu planto o ritual: /pm-chief-of-staff:plantar fechar-semana (a skill copiada do plugin vira um arquivo seu, editável)".
